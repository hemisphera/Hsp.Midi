...
public class InputMidiDevicePool : MidiDevicePool<InputMidiDevice>
{
  ...
  protected override InputMidiDevice CreateDevice(MidiDeviceInfo info)
  {
    return new InputMidiDevice(info);
  }
